...
const ProductDetails = () => {
  ...
  // Find the product by ID (convert id to a number if needed)
...
//     <div className="container mx-auto px-4 py-10 bg-gradient-to-r from-orange-100 to-orange-200 min-h-screen mt-20">
//       <div className="flex flex-col md:flex-row bg-orange-100 shadow-lg rounded-lg m-6">
//         {/* Left Side - Product Image */}
...
//           {/* Buttons */}
//           <div className="flex flex-wrap gap-2" data-testid="cart-wishlist-button">
//             <CartButton product={product} />
//             <WishlistButton product={product} />
//             <button className="bg-primary text-white px-6 py-2 rounded-lg hover:bg-orange-400 transition font-semibold shadow-md">
//               Buy Now
//             </button>
//           </div>
//         </div>
